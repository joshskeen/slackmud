module Command
  class GiveCommand < GameCommandBase
    ...
    def perform
      return I18n.t 'game.give_command.no_item_matching' unless player_has_item?
      return I18n.t 'game.give_command.no_target' if target? || slack_text_array.length == 2
      return I18n.t 'game.give_command.target_not_found' unless room_has_player?
      return I18n.t 'game.give_command.quantity_not_found' unless player_has_quantity?
